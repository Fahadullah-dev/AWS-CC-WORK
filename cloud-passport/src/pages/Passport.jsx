...
export default function Passport({ onTerminated }) {
  ...
  // UPDATED: Now triggers after the custom popup confirmation
      ...
      <div style={{ backgroundColor: 'white', padding: '25px', color: 'black', boxSizing: 'border-box' }}>
        ...
        <form onSubmit={saveProfile} style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
            ...
            <div style={{flex: '1 1 100px'}}><label style={editLabel}>FIRST INTAKE</label><input required value={form.intake} onChange={e => setForm({...form, intake: e.target.value})} style={editInput} /></div>
          </div>
    ...
    <div style={{ backgroundColor: '#fafafa', position: 'relative', color: 'black', border: '8px solid white', boxSizing: 'border-box' }}>
        ...
        <div style={overlayStyle} onClick={() => setShowDeletePopup(false)}>
          <div style={popupCardStyle} onClick={e => e.stopPropagation()}>
            ...
            <div style={popupBodyStyle}>
              ...
              <p style={{ margin: 0 }}>You are about to permanently delete your builder identity from the AWS Student Builder Group registry. <strong>All XP, stamps, and networking data will be lost forever.</strong></p>
            </div>
      ...
      <div style={{ backgroundColor: '#1a1c21', padding: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', borderBottom: '4px solid #ff9900' }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          {/* UPDATED: Button triggers popup instead of window.confirm */}
      ...
      <div style={{ padding: '20px', boxSizing: 'border-box' }}>
        <div style={{ display: 'flex', gap: '15px', marginBottom: '25px', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <div style={{ flex: 1, textAlign: 'left', minWidth: '150px' }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: 'black', color: 'white', padding: '6px 12px', fontWeight: '900', fontSize: '12px', border: '2px solid #00e87f' }}>
...
const dataBoxStyle = { border: '3px solid black', padding: '12px', backgroundColor: 'white', boxSizing: 'border-box' };
...
const dataValStyle = { fontSize: '13px', fontWeight: '900', color: 'black' };
